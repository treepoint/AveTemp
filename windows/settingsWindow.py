...
"                qproperty-icon: url(\" \"); /* empty image */\n"
"                /*qproperty-iconSize: 20px 20px;  space for the background image */\n"
"                border-image: url(./images/boosty.png);\n"
"                background-repeat: no-repeat;\n"
"            }\n"
"\n"
"            QPushButton:hover {\n"
"                border-image : url(./images/boosty_hover.png);\n"
"                background-repeat: no-repeat;\n"
"            }\n"
"\n"
"            QPushButton:pressed\n"
"            {\n"
"                border-image : url(./images/boosty_pressed.png);\n"
"                background-repeat: no-repeat;\n"
"            }")
        ...
        "    qproperty-icon: url(\" \"); /* empty image */\n"
        "    /*qproperty-iconSize: 20px 20px;  space for the background image */\n"
        "    border-image: url(./images/patreon.png);\n"
        "    background-repeat: no-repeat;\n"
        "}\n"
        "\n"
        "    QPushButton:hover {\n"
        "     border-image : url(./images/patreon_hover.png);\n"
        "     background-repeat: no-repeat;\n"
        "}\n"
        "\n"
        "    QPushButton:pressed\n"
        "     {\n"
        "       border-image : url(./images/patreon_pressed.png);\n"
        "       background-repeat: no-repeat;\n"
        "}")
